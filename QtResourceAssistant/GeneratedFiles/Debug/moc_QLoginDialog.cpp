...
QT_MOC_LITERAL(1, 13, 11), // "loginSignal"
QT_MOC_LITERAL(2, 25, 0) // ""

    },
    "QLoginDialog\0loginSignal\0"
};
...
void QLoginDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QLoginDialog *_t = static_cast<QLoginDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (QLoginDialog::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QLoginDialog::loginSignal)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject QLoginDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_QLoginDialog.data,
      qt_meta_data_QLoginDialog,  qt_static_metacall, nullptr, nullptr}
};
